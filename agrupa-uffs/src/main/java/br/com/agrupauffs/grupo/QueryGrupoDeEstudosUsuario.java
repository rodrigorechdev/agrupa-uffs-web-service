...
public interface QueryGrupoDeEstudosUsuario extends CrudRepository<EntidadeGrupoEstudoUsuario, Integer>{
    ...
    @Transactional
    @Modifying
    @Query(value = "insert into grupo_estudo_usuario (id_grupo_estudo, id_usuario, administrador, pedido_pendente) values (:idGrupo , :idUsuario, false, :pedidoPendente)", nativeQuery = true)
    public void insereNaTabela(@Param("idGrupo") int idGrupo, @Param("idUsuario") int idUsuario, @Param("pedidoPendente") boolean pedidoPendente); 
